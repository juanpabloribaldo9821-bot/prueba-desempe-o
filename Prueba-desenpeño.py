...
create_record({'id': '1', 'name': 'Ribaldo', 'course': 'PYTHON' , 'age':'27'})
create_record({'id': '2', 'name': 'Luis', 'course': 'JAVA' ,'age':'30'})

print("Registros actuales:", read_log())

update_record('1', {'id': '1', 'name': 'Ribaldo', 'course' : 'PYTHON','age':'27'})
delete_record('2')
